...
export const metadata: Metadata = {
  title: "Accessibility Statement | CompareLoans.xyz",
  description: "CompareLoans.xyz is committed to ensuring digital accessibility for people with disabilities.",
}
